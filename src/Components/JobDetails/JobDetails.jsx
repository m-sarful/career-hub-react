...
const JobDetails = () => {
    ...
    const {job_title, company_name, remote_or_onsite, location, job_type, salary, job_description, job_responsibility, educational_requirements, contact_information, experiences} = job;
    console.log(job)
    // console.log(jobs, id)
    return (
        <div>
           ...
           <div className="mt-4 flex gap-4">
            ...
            <div className="mt-4">
                ...
                <div className="mt-2">
                    <button className="btn w-full bg-gradient-to-r from-blue-500 to-purple-500 text-white">Apply Now</button>
                </div>
            </div>
            </div>
           </div>
